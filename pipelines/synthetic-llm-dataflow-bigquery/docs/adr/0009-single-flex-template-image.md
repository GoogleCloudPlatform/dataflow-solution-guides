...
- [ADR 0015](0015-worker-image-via-artifact-registry.md) — where this image is pushed and pulled from; [`public_cloud/deploy/gcp/README.md`](https://github.com/albertols/synthetic-llm-dataflow-bigquery/blob/d32c34743d80c8481445956939b6bbde9c4d4a3c/public_cloud/deploy/gcp/README.md) — a runnable build/deploy path.
