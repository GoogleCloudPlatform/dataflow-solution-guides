...
- **Scope**: formalizes and supersedes the fidelity/privacy portion of the
  "Mode B validation pipeline" bullet in [`docs/ROADMAP.md`](https://github.com/albertols/synthetic-llm-dataflow-bigquery/blob/a01e54abd46e676b53f344bd8ba5d10af231de21/docs/ROADMAP.md) M2 (the
