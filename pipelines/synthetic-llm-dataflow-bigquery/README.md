...
- **GPU machine / M4 onboarding** → [`docs/M4_SETUP.md`](https://github.com/albertols/synthetic-llm-dataflow-bigquery/blob/a01e54abd46e676b53f344bd8ba5d10af231de21/docs/M4_SETUP.md)
- **What must exist before a run** (buckets, datasets, IAM) → [`docs/DEPLOYMENT_PREREQUISITES.md`](docs/DEPLOYMENT_PREREQUISITES.md)
- **Personal-GCP cost-capped runs** → [`public_cloud/deploy/gcp/README.md`](https://github.com/albertols/synthetic-llm-dataflow-bigquery/blob/a01e54abd46e676b53f344bd8ba5d10af231de21/public_cloud/deploy/gcp/README.md)
...
- **Interpret** with the report generators in [`.github/prompts/`](https://github.com/albertols/synthetic-llm-dataflow-bigquery/blob/a01e54abd46e676b53f344bd8ba5d10af231de21/.github/prompts): the end-to-end validation report, the free-text crosscheck report, and the prompt-constraint recommender.
...
| Releases | [`docs/releases/`](https://github.com/albertols/synthetic-llm-dataflow-bigquery/blob/a01e54abd46e676b53f344bd8ba5d10af231de21/docs/releases/README.md) | per-version deterministic reports (aggregate metrics and charts) |
| Articles | [`docs/articles/`](https://github.com/albertols/synthetic-llm-dataflow-bigquery/blob/a01e54abd46e676b53f344bd8ba5d10af231de21/docs/articles/README.md) | the Medium series — VCS-tracked, kept in sync with the implementation |
...
| Machine matrix, SDK-container and worker caps | [`docs/RUN_PLAYBOOK.md`](https://github.com/albertols/synthetic-llm-dataflow-bigquery/blob/a01e54abd46e676b53f344bd8ba5d10af231de21/docs/RUN_PLAYBOOK.md), `composer/synthetic_beam_bigquery.py`, `public_cloud/deploy/gcp/tiers.yaml` |
