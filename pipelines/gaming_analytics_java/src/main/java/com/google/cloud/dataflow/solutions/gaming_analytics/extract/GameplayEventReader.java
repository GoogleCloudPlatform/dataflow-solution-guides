 ...
 */
package com.google.cloud.dataflow.solutions.gaming_analytics.extract;
...
/** Reads the raw gameplay events published by the gaming platform servers to Cloud Pub/Sub. */
public final class GameplayEventReader {

    private GameplayEventReader() {}

    public static Read fromSubscription(String subscription) {
        return Read.builder().withSubscription(subscription).build();
    }

    /** Composite transform reading JSON strings from a Pub/Sub subscription. */
    @AutoValue
    public abstract static class Read extends PTransform<PBegin, PCollection<String>> {
        ...
        public static Builder builder() {
            return new AutoValue_GameplayEventReader_Read.Builder();
        }
