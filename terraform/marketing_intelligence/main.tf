...
module "registry_docker" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/artifact-registry?ref=v38.2.0"
...
module "enrichment_table" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/bigtable-instance?ref=v38.2.0"
  project_id = module.google_cloud_project.project_id
...
module "output_dataset" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/bigquery-dataset?ref=v38.2.0"
  project_id = module.google_cloud_project.project_id
...
module "regional_nat" {
  ...
  source         = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-cloudnat?ref=v38.2.0"
  project_id     = module.google_cloud_project.project_id
  region         = var.region
