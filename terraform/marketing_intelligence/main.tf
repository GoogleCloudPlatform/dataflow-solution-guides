...
module "google_cloud_project" {
  source          = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/project?ref=v37.2.0"
...
module "registry_docker" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/artifact-registry?ref=v37.2.0"
...
module "buckets" {
  source        = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/gcs?ref=v37.2.0"
  project_id    = module.google_cloud_project.project_id
...
module "input_topic" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/pubsub?ref=v37.2.0"
  project_id = module.google_cloud_project.project_id
...
module "enrichment_table" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/bigtable-instance?ref=v37.2.0"
  project_id = module.google_cloud_project.project_id
...
module "output_dataset" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/bigquery-dataset?ref=v37.2.0"
  project_id = module.google_cloud_project.project_id
...
// Service account
module "dataflow_sa" {
  source       = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/iam-service-account?ref=v37.2.0"
  project_id   = module.google_cloud_project.project_id
...
// Network
module "vpc_network" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-vpc?ref=v37.2.0"
  project_id = module.google_cloud_project.project_id
...
module "firewall_rules" {
  ...
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-vpc-firewall?ref=v37.2.0"
  project_id = module.google_cloud_project.project_id
...
module "regional_nat" {
  ...
  source         = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-cloudnat?ref=v37.2.0"
  project_id     = module.google_cloud_project.project_id
  region         = var.region
...
resource "local_file" "variables_script" {
  filename        = "${path.module}/../../pipelines/market_intelligence/scripts/00_set_variables.sh"
